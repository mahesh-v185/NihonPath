...
const about = `Welcome to NihonPath – Your Japanese Training Ground!
If you've ever studied Japanese, you know that learning the language isn't just about memorizing words and grammar rules—it's about practice, repetition, and real-world application. That's exactly what NihonPath is all about!

Just like a real dojo, NihonPath is a place for training, discipline, and mastery—but instead of martial arts, we're here to help you sharpen your Japanese language skills. Whether you're a complete beginner or an intermediate learner looking to level up, you're in the right place.
...
At NihonPath, we focus on active learning. This means:
...
No matter where you are in your Japanese learning journey, NihonPath is here to help you become stronger, more skilled, and more confident in your abilities. Whether you're preparing for the JLPT, planning a trip to Japan, or just passionate about the language, we're here to guide you every step of the way.
...
🚀 Start your training today with NihonPath 🚀`;
